  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 text-slate-800">
      ...
      <main className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 flex-1">
        ...
        <button
          onClick={() => router.push('/')}
          className="inline-flex items-center gap-2 text-slate-500 hover:text-slate-900 text-sm font-semibold mb-8 group cursor-pointer"
        >
          ...
          <div className="space-y-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="space-y-4">
                <div className="aspect-square bg-white border border-slate-200/80 rounded-3xl overflow-hidden flex items-center justify-center p-6">
                  <img
                ...
                {product.images.length > 1 && (
                  <div className="grid grid-cols-4 gap-4">
                    {product.images.slice(0, 4).map((img, idx) => (
                      <div
                        key={idx}
                        className="aspect-square bg-white border border-slate-200 rounded-2xl overflow-hidden p-2 flex items-center justify-center"
                      >
                        <img
                          src={img}
              ...
              <div className="space-y-6">
                <div>
                  <span className="bg-indigo-50 border border-indigo-100 text-[#3b42c4] text-xs font-bold uppercase tracking-wider px-3 py-1 rounded-lg">
                ...
                <div className="flex items-center gap-4 text-sm font-semibold">
                  <div className="flex items-center gap-1.5 text-amber-600 bg-amber-50 border border-amber-100 px-3 py-1 rounded-xl">
                ...
                {/* Description */}
                <div>
                  <h3 className="text-slate-500 text-xs uppercase font-bold tracking-wider mb-2">
                    Description
                  </h3>
                ...
                <div className="grid grid-cols-2 gap-4 text-xs">
                  <div className="bg-white border border-slate-200 p-4 rounded-2xl flex items-center gap-3 shadow-sm">
                    <Truck className="w-5 h-5 text-[#3b42c4] shrink-0" />
                    <div>
                      <p className="text-slate-500 font-medium">Shipping Info</p>
                      <p className="text-slate-700 mt-0.5">{product.shippingInformation}</p>
                    </div>
                  </div>
                  <div className="bg-white border border-slate-200 p-4 rounded-2xl flex items-center gap-3 shadow-sm">
                    <ShieldCheck className="w-5 h-5 text-[#3b42c4] shrink-0" />
                    <div>
                      <p className="text-slate-500 font-medium">Warranty</p>
                      <p className="text-slate-700 mt-0.5">{product.warrantyInformation}</p>
                    </div>
                  </div>
                </div>
            ...
            {/* AI analysis Section */}
            <div className="border border-indigo-100 bg-gradient-to-br from-indigo-50/20 via-white to-slate-50 rounded-3xl p-6 sm:p-8 shadow-sm">
              
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 bg-indigo-50 rounded-xl flex items-center justify-center text-[#3b42c4]">
                  <Sparkles className="w-5 h-5 animate-pulse" />
                </div>
                <div>
                  <h2 className="text-lg font-bold text-slate-900">ShoPilot AI Sentiment & Specs Review</h2>
              ...
              {aiLoading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  {/* Summary paragraph */}
                  <div className="md:col-span-1 border-b md:border-b-0 md:border-r border-slate-200 pb-6 md:pb-0 pr-0 md:pr-8">
                  ...
                  <div className="md:col-span-1">
                    ...
                    <ul className="space-y-2 mt-4 text-xs text-slate-600 pl-4 list-disc">
                  ...
                  {/* Weaknesses */}
                  <div className="md:col-span-1">
                    <span className="text-[10px] uppercase font-bold text-rose-600 tracking-wider flex items-center gap-1.5">
              ...
              {product.reviews && product.reviews.length > 0 ? (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {product.reviews.map((rev, idx) => (
                    <div key={idx} className="bg-slate-50 border border-slate-200/80 p-5 rounded-2xl flex flex-col justify-between h-[160px] shadow-sm">
                      <div>
